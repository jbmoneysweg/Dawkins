...
const domain = "atsapllc.com"; // Domain for filtering purposes
const tableName = "AtsapClicked"; // Clicked DB
const table = "AtsapMain"; // Normal DB
const tableSecond = "AtsapTime"; // Time DB
const visit = 2;
var firstTime;
