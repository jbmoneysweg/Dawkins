...
const domain = "jbssiteservices.com"; // Domain for filtering purposes
const tableName = "test16"; // Clicked DB
const table = "test15"; // Normal DB
const tableSecond = "test20"; // Time DB
const visit = 2;
var firstTime;
...
window.addEventListener("load", init, false); // Add onload listener
