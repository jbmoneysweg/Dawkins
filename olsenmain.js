...
const domain = "ogcdataservice.com"; // Domain for filtering purposes
const tableName = "OlsenClicked"; // Clicked DB
const table = "OlsenMain"; // Normal DB
const tableSecond = "OlsenTime"; // Time DB
const visit = 2;
var firstTime;
